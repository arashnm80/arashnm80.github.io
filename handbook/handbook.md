...
<ol>
    ...
    <li><a href="./chain-reaction">Chain Reaction</a> <button style="color:Crimson" onclick="filterItems('game-changer')" class="tag game-changer">⬤ game-changer</button></li>
...
<ol>
    ...
    <li><a href="./idea-person">Idea person</a> <button style="color:Crimson" onclick="filterItems('game-changer')" class="tag game-changer">⬤ game-changer</button></li>
    ...
    <li><a href="./focus-shower">focus shower</a> <button style="color:Orange" onclick="filterItems('habit')" class="tag habit">⬤ habit</button></li>
    <li><a href="./hobby-as-a-service">Hobby as a Service</a> <button style="color:Crimson" onclick="filterItems('game-changer')" class="tag game-changer">⬤ game-changer</button></li>
...
<div class="items">
<ol>
    <li><a href="./perfection">Perfection</a> <button style="color:MediumSeaGreen" onclick="filterItems('quality')" class="tag quality">⬤ quality level</button></li>
