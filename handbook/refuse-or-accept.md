...
sometimes it might mean to fight with all of my power and be fast, sometimes might mean the opposite and slow down.  
**so the best strategy is to always being in second one while always re-assessing if it's time for first one or not**
...
- some have mental knots and problems and harness them
and of course all of these are in service of survival.
...
observation: i sleep a lot when i'm down and crave the most to leave. the reason maybe is that sleeping is the closest thing to death.
